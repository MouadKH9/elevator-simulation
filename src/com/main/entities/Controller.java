...
public class Controller {
	...
	public void checkElevatorDests(Elevator elevator) {
		elevator.getDests().sort((c1, c2) -> {
			return elevator.elevatorY - c1.getFloor().getCeilingY() > elevator.elevatorY - c2.getFloor().getCeilingY()
					? 1
					: -1;
		});
	...
	public Elevator getClosest(ElevatorCall call) {
		return Math.abs(e1.getCurrentFloor() - call.getFloor().getNumber()) < Math
				.abs(e2.getCurrentFloor() - call.getFloor().getNumber()) ? e1 : e2;
	}
